        ...
        <div>
            <div className="w-full mx-auto mb-5">
                ...
                <div className="w-10/12 mx-auto">
                    ...
                    <h1 className="text-3xl font-semibold  mb-2">{showdata.title}</h1>
                    <Link to={'/Services'}><button className="btn btn-sm ">previous page</button></Link>
                    </div>
